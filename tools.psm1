# Creats an emtpy file of a specific size. Useful for testing bandwidth and speed.
Function New-file($filesize) {
	<#
        .DESCRIPTION
		Created emtpy file with a listed size for bandwidth and speed testing
        .PARAMETER
		File size in MB
        .EXAMPLE
		create-file 100
		Creates a 100MB file in the directory
        .INPUTS
		Filesize in MB
        .OUTPUTS
...
# Relaunch shell as admin if not already running as admin
Function admin {
